...
export type HaFormSchema = HaFormField | HaFormGrid;

export const ENTITY_BASE_SCHEMA: HaFormField[] = [
...
export function buildAppearanceSchema(style: string): HaFormField[] {
...
export const DATA_SCHEMA: HaFormField[] = [
